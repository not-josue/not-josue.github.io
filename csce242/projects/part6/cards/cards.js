    ...
    sortedData = {
      all: {
        ascending: {
          ...
          "triumphant-light": ascAll.filter(
            (el) => el.set === "Triumphant Light"
          ),
        },
        descending: {
          all: descAll,
          ...
          "triumphant-light": descAll.filter(
            (el) => el.set === "Triumphant Light"
          ),
        },
      },
      pokemon: {
        ascending: {
          ...
          "triumphant-light": ascPokemon.filter(
            (el) => el.set === "Triumphant Light"
          ),
        },
        descending: {
          ...
          "triumphant-light": descPokemon.filter(
            (el) => el.set === "Triumphant Light"
          ),
        },
      },
      supporter: {
        ascending: {
          ...
          "triumphant-light": ascSupporters.filter(
            (el) => el.set === "Triumphant Light"
          ),
        },
        descending: {
          ...
          "triumphant-light": descSupporters.filter(
            (el) => el.set === "Triumphant Light"
          ),
        },
      },
      item: {
        ascending: {
          ...
          "triumphant-light": ascItems.filter(
            (el) => el.set === "Triumphant Light"
          ),
        },
        descending: {
          ...
          "triumphant-light": descItems.filter(
            (el) => el.set === "Triumphant Light"
          ),
        },
      },
