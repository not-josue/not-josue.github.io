...
These are the HTML structure for all the components that are used on the site.
...
<header>
        <nav id="prime-nav">
            <!-- Hamburger -->
            <button id="hamburger" aria-expanded="false" aria-haspopup="menu" aria-label="navigation menu">
        ...
        <nav id="mobile-nav" class="hidden">
            ...
            <div>
                ...
                <div>
                    <button>
                        <svg id="sun" xmlns="http://www.w3.org/2000/svg" height="28" width="28"
                        ...
                        <svg id="moon" xmlns="http://www.w3.org/2000/svg" height="28" width="22"
